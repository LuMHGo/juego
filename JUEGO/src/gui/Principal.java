...
public class Principal extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        p1.setBackground(new java.awt.Color(145, 74, 74));
        ...
        p7.setBackground(new java.awt.Color(204, 102, 0));
        ...
        p10.setBackground(new java.awt.Color(255, 102, 102));
        ...
        p4.setText("PINEAPPLE");
        p4.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        p4.setOpaque(true);

        jLabel3.setText("ALMENDRA");

        jLabel4.setText("MANZANA");

        jLabel5.setText("PLATANO");

        jLabel6.setText("PIÑA");

        jLabel7.setText("FRAMBUESA");

        jLabel8.setText("CEREZA");

        jLabel9.setText("NUECES");

        jLabel10.setText("LIMA");

        jLabel11.setText("COCO");

        jLabel12.setText("LICHI");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(p5, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
    ...
    public void presioneClic(java.awt.event.MouseEvent evt) {
        if (!gano) {//verifica si gano el juego
            ...
            {
                evt.getComponent().setBackground(new java.awt.Color(255, 204, 0));//si esta de color blanco la pone de color azul
                tachar();
    ...
    public void tachar() 
    {
        ...
        if (aux) {
            ...
            { //esto comprueba si la ventana no esta en memoria, entonces la instancia
                ...
                JOptionPane.showMessageDialog(null,"HAS DESBLOQUEADO EL SIGUIENTE NIVEL");
